...
namespace MewoMod.Content.Tiles.Furniture
{
	...
	public class LordMewoRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "MewoMod/Content/Tiles/Furniture/LordMewoRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "MewoMod/Content/Tiles/Furniture/RelicPedestal";
