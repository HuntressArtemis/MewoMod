...
namespace MewoMod.Common.Systems
{
	...
	{
		public static bool DownedMewoBoss = false;
		// public static bool downedOtherBoss = false;

		public override void ClearWorld() {
			DownedMewoBoss = false;
		...
		public override void LoadWorldData(TagCompound tag) {
			DownedMewoBoss = tag.ContainsKey("DownedMewoBoss");
		...
		public override void NetSend(BinaryWriter writer) {
			...
			*/
			...
			// BitsByte flags = new BitsByte(DownedMewoBoss, downedOtherBoss);
			// writer.Write(flags);
